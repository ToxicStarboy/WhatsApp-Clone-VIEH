...
function ChatDetail() {
  ...
  return (
    ...
    <div className="flex flex-col h-screen">
      {/* Contact nav */}
      <div className="flex justify-between bg-[#075e54] h-[60px] p-3">
        {/* Contact info */}
        <div className="flex items-center">
          ...
          <div className="flex flex-col">
            {/* Contact */}
            <h1 className="text-white font-medium">WhatsApp</h1>
      ...
      {/* Messages section */}
      <div
        className="bg-[#0a131a] bg-[url('assets/images/lightbg.jpg')] bg-contain overflow-y-scroll h-100"
