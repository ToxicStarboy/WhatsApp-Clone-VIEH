...
function Message({ msg, time, isLink, img, sent }) {
  return (
    // Message container
    <div
      className={`flex justify-center shadow-md items-center rounded-md w-fit my-1 ${
        sent ? "bg-[#dcf8c6] ml-auto" : "bg-[#ffffff] mr-auto"
      }`}
    >
      {/* Image message */}
      {img ? (
        ...
        >
          ...
          {isLink ? (
            ...
            // Normal text
            <p className="text-black text-sm mr-2">{msg}</p>
          )}
